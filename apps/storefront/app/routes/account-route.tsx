...
export function AccountRoute() {
  const { openAuth, savedAddresses, venue } = useOutletContext<StorefrontLayoutContext>();
  ...
  return <AccountScreen
    ...
    onRequestPhoneChange={() => openAuth({ context: "account", initialStep: "phone", phone: { countryCode: customer.countryCode, phone: customer.phone }, onSuccess: () => {} })}
    onSaveCustomer={customerSession.updateLocalProfile}
    onSignOut={() => { void customerSession.signOut(); navigate("/"); }}
    venue={venue}
  />;
}
