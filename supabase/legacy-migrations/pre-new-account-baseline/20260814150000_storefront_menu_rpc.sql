-- Customer-facing catalog boundary. It intentionally returns only the data
-- required to browse and configure a location's menu; final order pricing is
-- still calculated by the checkout/order boundary.
...
comment on function ordering.get_storefront_menu(uuid) is
  'Returns a location-scoped customer menu. Invalid or inactive locations return null.';
